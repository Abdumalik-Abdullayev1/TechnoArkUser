        ...
        <div className='flex'>
          <div className='flex gap-2 w-full xl:w-[80%]'>
            <div className='hidden w-[20%] xl:flex xl:flex-col justify-around gap-1'>
              <Image src={data?.data?.product?.images?.[0]} alt="product-main" className="w-full" />
              <Image src={data?.data?.product?.images?.[0]} alt="product-main" className="w-full" />
              <Image src={data?.data?.product?.images?.[0]} alt="product-main" className="w-full" />
              <Image src={data?.data?.product?.images?.[0]} alt="product-main" className="w-full" />
            </div>
            <span className='w-[100%] flex flex-col justify-center items-center xl:w-[80%]'><Image src={data?.data?.product?.images?.[0]} alt="product-main" className="xl:w-full md:w-[60%]" /></span>
