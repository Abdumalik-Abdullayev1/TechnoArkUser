...
const Page = () => {
    const card = [
        ...
        { id: 5, img: <div className='bg-[rgb(230,238,246)] p-5 rounded-md xl:hidden'><Image src={AirPods} width={300} alt='AirPods' priority /></div>, sales:<p className='bg-white px-2 text-red-700 rounded-md font-semibold xl:hidden'>Aksiyada</p>, like: <IoMdHeartEmpty className='xl:hidden' />, title: <p className='xl:hidden'>Смартфон Xiaomi 12 Lite 8/128Gb Қора</p>, price: <p className='xl:hidden'>6 999 999usz</p>, sale: <p className='xl:hidden'>6 X/568 999</p>, scales: <PiScalesLight className='xl:hidden' />, cart: <button className='flex items-center gap-1 bg-blue-800 px-5 py-2 text-white lg:px-10 rounded-md xl:hidden'>Savatcha<CgShoppingBag /></button> },
