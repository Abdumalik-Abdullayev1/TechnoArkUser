...
export const card = [
    ...
    { id: 3, img: <div className='bg-[rgb(230,238,246)] p-5 rounded-md'><Image src={AirPods} width={300} alt='AirPods' priority /></div>, like: <IoMdHeartEmpty />, title: "Смартфон Xiaomi 12 Lite 8/128Gb Қора", price: "6 999 999usz", sale: "6 X/568 999", scales: <PiScalesLight /> },
    { id: 4, img: <div className='bg-[rgb(230,238,246)] p-5 rounded-md'><Image src={Phone} width={300} alt='AirPods' priority /></div>, like: <IoMdHeartEmpty />, title: "Смартфон Xiaomi 12 Lite 8/128Gb Қора", price: "6 999 999usz", sale: "6 X/568 999", scales: <PiScalesLight /> },
