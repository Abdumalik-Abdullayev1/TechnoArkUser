    ...
    return (
        <div className="mt-10 sm:grid sm:grid-flow-col sm:items-center xl:px-32">
            <div className="sm:w-32 md:w-36 lg:w-64 px-5 grid grid-flow-col items-center">
                ...
                <button className="text-[22px] sm:hidden"><RxHamburgerMenu /></button>
            </div>
            <div className="flex items-center gap-3 px-5">
                <div>
                    <button className="flex items-center bg-blue-600 text-white px-2 py-2 rounded-md lg:px-8 lg:py-4">Kategorya<IoIosArrowDown /></button>
                </div>
                <div className="w-[80%] flex justify-between bg-slate-200 rounded-md xl:w-[35vw] ">
                    ...
                    <button className="flex justify-center items-center bg-blue-600 text-white w-[20%] py-3 rounded-md lg:text-xl"><IoIosSearch /></button>
                </div>
            </div>
